...
export default {
  ...
  methods: {
    ...
    setValueToForm(data){
      ...
      this.basicForm.department = data.department + ''
      this.basicForm.email = data.email + ''
      this.basicForm.gender = data.gender + ''
      this.basicForm.hid = data.hid + ''
      ...
      this.technicalForm.mediPractiRange = data.mediPractiRange.split(',')
      this.technicalForm.mediPractiType = data.mediPractiType + ''
      this.technicalForm.medicalPostName = data.medicalPostName + ''
      this.technicalForm.postName = data.postName + ''
      this.manageForm.productField = data.productField.split(',')
