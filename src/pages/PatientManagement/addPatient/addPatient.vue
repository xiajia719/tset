          ...
          <el-form-item label="就诊医生" prop="doctor">
            ...
            >
              <el-option
                ...
                :label="item.cname + '_' + item.hospitalName"
                :value="item.id"
                :key="item.id"
              >
              </el-option>
          ...
          <div class="treatmentItem" v-for="(item,index) in treatmentData" :key="index">
            <el-form class="addTreatmentForm" :model="item" label-width="105px" :rules="addTreatmentRules" ref="treatmentForm">
              ...
              <el-form-item label="患者类型" prop="patientType">
                <el-select v-model="item.patientType" style="width: 270px;" :popper-append-to-body='false'>
                  <el-option
              ...
              <el-form-item label="治疗类型" prop="treatmentType">
                <el-select v-model="item.treatmentType" style="width: 270px;" :popper-append-to-body='false'>
                  <el-option
              ...
              <el-form-item label="是否新病人" prop="isNewPatient">
                <el-select v-model="item.isNewPatient" style="width: 270px;" :popper-append-to-body='false'>
                  <el-option
              ...
              <el-form-item label="是否替换" prop="isReplace">
                <el-select v-model="item.isReplace" style="width: 270px;" :popper-append-to-body='false'>
                  <el-option
              ...
              <el-form-item label="治疗状态" prop="treatmentStatus">
                <el-select v-model="item.treatmentStatus" style="width: 270px;" :popper-append-to-body='false'>
                  <el-option
              ...
              <el-form-item label="销售途径" prop="salesChannel">
                <el-select v-model="item.salesChannel" style="width: 270px;" :popper-append-to-body='false'>
                  <el-option
...
export default {
  ...
  mounted(){
    this.getOptions()
    this.getCustomerBindProduct(this.userId,'')
    // 从客户管理页面来携带客户id,赋值到就诊医生
    if(this.currentCustomerId){
      this.basicForm.doctor = this.currentCustomerId
                ...
                if (valid) {
                  ...
                  axios.post(`/api-crm-member/crmMemberInfo/update`,params,{
                    ...
                    if(res.data.code == 0){
                      ...
                      this.$router.push({name:'PatientInfo',params: {mid:res.data.data}})
                    }else{
